...
<body>
    ...
    <hr>
        <?php 
                if (isset($_COOKIE['cate_add_false'])) {
             ?>
                <div class="alert alert-danger">
                    <strong>Thông báo!</strong> Yêu cầu nhập đủ thông tin!
                </div>
        <?php } ?>
        <form action="addProcess.php" method="POST" role="form" enctype="multipart/form-data">
